...
public class WeekView extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.HDWWeekView, defStyleAttr, defStyleRes);

        mVerticalPadding = a.getDimensionPixelOffset(R.styleable.HDWWeekView_hdw_wv_verticalPadding, ThemeUtil.dpToPx(context, 8));
        mHorizontalPadding = a.getDimensionPixelOffset(R.styleable.HDWWeekView_hdw_wv_horizontalPadding, ThemeUtil.dpToPx(context, 8));
        int animDuration = a.getInteger(R.styleable.HDWWeekView_hdw_wv_animDuration, context.getResources().getInteger(android.R.integer.config_mediumAnimTime));
        mBackgroundColors = a.getColorStateList(R.styleable.HDWWeekView_hdw_wv_backgroundColor);
