...
package com.handy.widget.app.spinner;
...
import com.handy.widget.spinner.MaterialSpinner;
import com.handy.widget.spinner.MaterialSpinnerAdapter;
import com.handy.widget.spinner.SpinnerItemShowApi;
...
//        复杂设置
        ...
        adapter.setTextColor(getResources().getColor(R.color.hdw_dialog_ios_btntext_blue));
