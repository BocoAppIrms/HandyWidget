package com.handy.widget.dialog.interfaces;
...
import com.handy.widget.dialog.adapter.SuperLvAdapter;
import com.handy.widget.dialog.adapter.SuperLvHolder;
import com.handy.widget.dialog.bottomsheet.BottomSheetBean;
import com.handy.widget.dialog.bottomsheet.BsGvHolder;
import com.handy.widget.dialog.bottomsheet.BsLvHolder;
import com.handy.widget.dialog.config.ConfigBean;
import com.handy.widget.dialog.config.DefaultConfig;
import com.handy.widget.dialog.view.GifMovieView;
import com.handy.widget.dialog.view.IosActionSheetHolder;
import com.handy.widget.dialog.view.IosAlertDialogHolder;
import com.handy.widget.dialog.view.IosCenterItemHolder;
...
public class MyDialogBuilder {
    ...
    private void buildBottomSheetLv(final ConfigBean bean) {
        final BottomSheetDialog dialog = new BottomSheetDialog(bean.context);
        LinearLayout root = (LinearLayout) View.inflate(bean.context, R.layout.hdw_dialog_bottomsheet_lv, null);
    ...
    protected ConfigBean buildLoading(ConfigBean bean) {
        View root = View.inflate(bean.context, R.layout.hdw_dialog_loading, null);
    ...
    protected ConfigBean buildMdLoading(ConfigBean bean) {
        View root = View.inflate(bean.context, R.layout.hdw_dialog_progressview_wrapconent, null);
        TextView tvMsg = (TextView) root.findViewById(R.id.loading_msg);
        StyledDialog.setTv_msg(tvMsg);
        tvMsg.setText(bean.msg);
        bean.dialog.setContentView(root);
    ...
    protected ConfigBean buildBottomItemDialog(ConfigBean bean) {
        ...
        window.setWindowAnimations(R.style.hdw_dialog_mystyle);
        return bean;
    }
