package com.handy.widget.dialog.view;
...
public class IosActionSheetHolder extends SuperHolder {
    ...
    protected void findViews() {
        ...
        lv.setDivider(new ColorDrawable(lv.getResources().getColor(R.color.hdw_dialog_line_dd)));
    ...
    protected int setLayoutRes() {
        return R.layout.hdw_dialog_ios_alert_bottom;
    }
    ...
    public void assingDatasAndEvents(final Context context, final ConfigBean bean) {
        ...
        BaseAdapter adapter = new BaseAdapter() {
            ...
            public View getView(final int position, View convertView, ViewGroup parent) {
                ...
                RelativeLayout root = (RelativeLayout) View.inflate(context, R.layout.hdw_dialog_item_btn_bottomalert, null);
                Button view = (Button) root.findViewById(R.id.btn);
                if (getCount() >= 2) {
                    if (position == 0) {
                        view.setBackgroundResource(R.drawable.hdw_dialog_selector_btn_press_all_top);
                    } else if (position == getCount() - 1) {
                        view.setBackgroundResource(R.drawable.hdw_dialog_selector_btn_press_all_bottom);
                    } else {
                        view.setBackgroundResource(R.drawable.hdw_dialog_selector_btn_press_no_corner);
                    }

                } else {
                    view.setBackgroundResource(R.drawable.hdw_dialog_selector_btn_press_all);
                }
