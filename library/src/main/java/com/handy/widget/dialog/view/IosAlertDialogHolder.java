...
public class IosAlertDialogHolder extends SuperHolder {
    ...
    protected int setLayoutRes() {
        return R.layout.hdw_dialog_ios_alert;
    }
    ...
    public void assingDatasAndEvents(Context context, final ConfigBean bean) {
        ...
        if (TextUtils.isEmpty(bean.text3)) {
            if (bean.isVertical) {
                ...
                btn2Vertical.setBackgroundResource(R.drawable.hdw_dialog_selector_btn_press_all_bottom);
            } else {
                btn3.setVisibility(View.GONE);
                lineBtn3.setVisibility(View.GONE);
                btn2.setBackgroundResource(R.drawable.hdw_dialog_selector_btn_press_right_bottom);
            }
        ...
        if (TextUtils.isEmpty(bean.text2)) {
            if (bean.isVertical) {
                ...
                btn1Vertical.setBackgroundResource(R.drawable.hdw_dialog_selector_btn_press_all_bottom);
            } else {
                btn2.setVisibility(View.GONE);
                lineBtn2.setVisibility(View.GONE);
                btn1.setBackgroundResource(R.drawable.hdw_dialog_selector_btn_press_all_bottom);
            }
        } else {
            if (bean.isVertical) {
