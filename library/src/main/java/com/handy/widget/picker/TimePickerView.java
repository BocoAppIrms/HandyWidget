package com.handy.widget.picker;
...
import com.handy.widget.picker.listener.CustomListener;
import com.handy.widget.picker.view.BasePickerView;
import com.handy.widget.picker.view.WheelTime;
...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    private void initView(Context context) {
        ...
        if (customListener == null) {
            LayoutInflater.from(context).inflate(R.layout.hdw_picker_time, contentContainer);
            ...
            //设置文字
            btnSubmit.setText(TextUtils.isEmpty(Str_Submit) ? context.getResources().getString(R.string.hdw_picker_submit) : Str_Submit);
            btnCancel.setText(TextUtils.isEmpty(Str_Cancel) ? context.getResources().getString(R.string.hdw_picker_cancel) : Str_Cancel);
    ...
    public static class Builder {
        ...
        private int layoutRes = R.layout.hdw_picker_time;
        private CustomListener customListener;
