package com.handy.widget.picker.lib;
...
import com.handy.widget.picker.adapter.WheelAdapter;
import com.handy.widget.picker.listener.OnItemSelectedListener;
import com.handy.widget.picker.model.IPickerViewData;
...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
       ...
       /* textColorOut = getResources().getColor(R.color.pickerview_wheelview_textcolor_out);
        ...
        textSize = getResources().getDimensionPixelSize(R.dimen.hdw_picker_textsize);//默认大小
        ...
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.HDWPickerview, 0, 0);
            mGravity = a.getInt(R.styleable.HDWPickerview_hdw_picker_gravity, Gravity.CENTER);
            textColorOut = a.getColor(R.styleable.HDWPickerview_hdw_picker_textColorOut, textColorOut);
            textColorCenter = a.getColor(R.styleable.HDWPickerview_hdw_picker_textColorCenter, textColorCenter);
            dividerColor = a.getColor(R.styleable.HDWPickerview_hdw_picker_dividerColor, dividerColor);
            textSize = a.getDimensionPixelOffset(R.styleable.HDWPickerview_hdw_picker_textSize, textSize);
            lineSpacingMultiplier = a.getFloat(R.styleable.HDWPickerview_hdw_picker_lineSpacingMultiplier, lineSpacingMultiplier);
            a.recycle();//回收内存
        }
