package com.handy.widget.widget;
...
import com.handy.widget.util.TypefaceUtil;
...
public class YearPicker extends ListView {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if(heightMode != View.MeasureSpec.EXACTLY){
            ...
            heightMeasureSpec = View.MeasureSpec.makeMeasureSpec(heightSize + getPaddingTop() + getPaddingBottom(), View.MeasureSpec.EXACTLY);
        }
