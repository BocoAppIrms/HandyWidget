...
import com.handy.widget2.material.widget.DatePicker;
import com.handy.widget2.material.widget.YearPicker;
...
public class DatePickerDialog extends Dialog {
    ...
    private class DatePickerLayout extends FrameLayout implements DatePicker.OnDateChangedListener, YearPicker.OnYearChangedListener {
        ...
        public void applyStyle(int resId) {
            ...
            @SuppressLint("CustomViewStyleable") TypedArray a = context.obtainStyledAttributes(resId, R.styleable.DatePickerDialog);
