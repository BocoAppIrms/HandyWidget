package com.handy.widget2.material.app;
...
import com.handy.widget2.R;
import com.handy.widget2.material.drawable.BlankDrawable;
import com.handy.widget2.material.drawable.RippleDrawable;
import com.handy.widget2.material.util.ThemeUtil;
import com.handy.widget2.material.util.ViewUtil;
import com.handy.widget2.material.widget.Button;
import com.handy.widget2.material.widget.TextView;
    ...
    public Dialog applyStyle(int resId) {
        ...
        for (int i = 0, count = a.getIndexCount(); i < count; i++) {
            ...
            if (attr == R.styleable.Dialog_android_layout_width) {
                layoutWidth = a.getLayoutDimension(attr, ViewGroup.LayoutParams.WRAP_CONTENT);
                layoutParamsDefined = true;
            } else if (attr == R.styleable.Dialog_android_layout_height) {
                layoutHeight = a.getLayoutDimension(attr, ViewGroup.LayoutParams.WRAP_CONTENT);
                layoutParamsDefined = true;
        ...
        if (layoutParamsDefined) {
            layoutParams(layoutWidth, layoutHeight);
        }
