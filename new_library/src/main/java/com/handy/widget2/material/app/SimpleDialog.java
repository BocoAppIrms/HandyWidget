...
import com.handy.widget2.material.widget.CheckBox;
import com.handy.widget2.material.widget.CompoundButton;
import com.handy.widget2.material.widget.ListView;
import com.handy.widget2.material.widget.RadioButton;
...
public class SimpleDialog extends Dialog {
    ...
    private class InternalScrollView extends ScrollView {
        ...
        public void onRtlPropertiesChanged(int layoutDirection) {
            @SuppressLint("InlinedApi") boolean rtl = layoutDirection == LAYOUT_DIRECTION_RTL;
            if (mIsRtl != rtl) {
                mIsRtl = rtl;
