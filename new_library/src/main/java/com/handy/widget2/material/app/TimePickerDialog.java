...
import com.handy.widget2.material.widget.CircleCheckedTextView;
import com.handy.widget2.material.widget.TimePicker;
...
public class TimePickerDialog extends Dialog {
    ...
    private class TimePickerLayout extends android.widget.FrameLayout implements View.OnClickListener, TimePicker.OnTimeChangedListener {
        ...
        public void applyStyle(int resId) {
            ...
            @SuppressLint("CustomViewStyleable") TypedArray a = context.obtainStyledAttributes(resId, R.styleable.TimePickerDialog);
